  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        setCategoryId(eventData.category_id ? String(eventData.category_id) : "");
        setMainImage(eventData.main_image || "");
        setTopImage(eventData.top_image || "");
        setMiddleImage(eventData.middle_image || "");
        setContentTop(eventData.content_top || "");
        setContentBottom(eventData.content_bottom || "");
        setCategories(categoriesData || []);

        if (eventData.top_image && eventData.middle_image) {
          setLayout("top-middle");
        } else if (eventData.top_image) {
          setLayout("top");
        } else if (eventData.middle_image) {
          setLayout("middle");
        } else {
          setLayout("none");
        }
